...
canopy.bind_with("p", { desc = "Log demo message" }, function()
    canopy.log("focus gym")
end)
canopy.bind_with("?", { desc = "Toggle help" }, function()
    root.toggle_help()
end)
canopy.bind_with("Tab", { path = "focus_gym", desc = "Next focus" }, function()
    root.focus("Next")
end)
canopy.bind_mouse_with("ScrollDown", { path = "focus_gym", desc = "Next focus" }, function()
    root.focus("Next")
end)
canopy.bind_mouse_with("ScrollUp", { path = "focus_gym", desc = "Previous focus" }, function()
    root.focus("Prev")
end)
canopy.bind_with("Right", { path = "focus_gym", desc = "Focus right" }, function()
    root.focus("Right")
end)
canopy.bind_with("l", { path = "focus_gym", desc = "Focus right" }, function()
    root.focus("Right")
end)
canopy.bind_with("Left", { path = "focus_gym", desc = "Focus left" }, function()
    root.focus("Left")
end)
canopy.bind_with("h", { path = "focus_gym", desc = "Focus left" }, function()
    root.focus("Left")
end)
canopy.bind_with("Up", { path = "focus_gym", desc = "Focus up" }, function()
    root.focus("Up")
end)
canopy.bind_with("k", { path = "focus_gym", desc = "Focus up" }, function()
    root.focus("Up")
end)
canopy.bind_with("Down", { path = "focus_gym", desc = "Focus down" }, function()
    root.focus("Down")
end)
canopy.bind_with("j", { path = "focus_gym", desc = "Focus down" }, function()
    root.focus("Down")
end)
canopy.bind_with("x", { path = "focus_gym", desc = "Delete focused block" }, function()
    focus_gym.delete_focused()
end)
canopy.bind_with("s", { path = "block", desc = "Split block" }, function()
    block.split()
end)
canopy.bind_with("a", { path = "block", desc = "Add child block" }, function()
    block.add()
end)
canopy.bind_with("[", { path = "block", desc = "Decrease grow" }, function()
    block.flex_grow_dec()
end)
canopy.bind_with("]", { path = "block", desc = "Increase grow" }, function()
    block.flex_grow_inc()
end)
canopy.bind_with("{", { path = "block", desc = "Decrease shrink" }, function()
    block.flex_shrink_dec()
end)
canopy.bind_with("}", { path = "block", desc = "Increase shrink" }, function()
    block.flex_shrink_inc()
end)
canopy.bind_mouse_with("LeftDown", { path = "block", desc = "Focus block" }, function()
    block.focus()
end)
canopy.bind_mouse_with("MiddleDown", { path = "block", desc = "Split block" }, function()
    block.split()
end)
canopy.bind_mouse_with("RightDown", { path = "block", desc = "Add child block" }, function()
    block.add()
end)
"#;
